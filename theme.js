function installThemeStyles() {
    ...
    style.textContent = `
        ...
        html.dark body { background:#1c1917 !important; color:#e7e5e4 !important; }
        html.dark .glass-nav,
        html.dark nav.glass-nav { background:rgba(28,25,23,0.92) !important; border-color:rgba(68,64,60,0.9) !important; }
        html.dark [class~="bg-white"],
        html.dark [class~="bg-stone-50"],
        html.dark [class~="bg-gray-50"],
        html.dark [class~="bg-white/95"],
        html.dark [class~="bg-stone-50/60"] { background-color:#221f1d !important; }
        html.dark [class~="bg-gray-100"],
        html.dark [class~="bg-gray-50/50"],
        html.dark [class~="bg-gray-50/70"] { background-color:#2c2724 !important; }
        ...
        html.dark [class~="border-green-100"] { border-color:#332f2c !important; }
        html.dark [class~="divide-gray-50"] > :not([hidden]) ~ :not([hidden]) { border-color:#2b2724 !important; }
        html.dark [class~="text-gray-900"],
        html.dark [class~="text-stone-800"] { color:#fafaf9 !important; }
        html.dark [class~="text-gray-700"],
        html.dark [class~="text-stone-700"],
        html.dark [class~="text-gray-800"],
        html.dark [class~="text-gray-600"] { color:#d6d3d1 !important; }
        ...
        html.dark [class~="text-gray-400"] { color:#a8a29e !important; }
        ...
        html.dark input,
        html.dark textarea,
        html.dark select { background:#1c1917 !important; color:#e7e5e4 !important; border-color:#332f2c !important; }
        html.dark .input-field::placeholder,
        html.dark input::placeholder,
        html.dark textarea::placeholder { color:#918a84 !important; }
        html.dark table thead,
        html.dark [class~="bg-gray-50"] thead { background:#26221f !important; }
        html.dark tr:hover { background:#26221f !important; }

        /* ── Fondos claros restantes ── */
        html.dark [class~="bg-brand-50/50"],
        html.dark [class~="bg-brand-100"] { background-color:#052e1a !important; }
        html.dark [class~="bg-gray-200"] { background-color:#2b2724 !important; }
        ...
        html.dark [class~="border-sun-200"] { border-color:#332f2c !important; }
        html.dark [class~="border-gray-50"] { border-color:#292524 !important; }
        html.dark img[class~="border-white"],
        html.dark [class~="border-white"] { border-color:#2c2724 !important; }

        /* ── Hovers: sin fogonazos blancos en oscuro ── */
        html.dark [class~="hover:bg-white"]:hover,
        html.dark [class~="hover:bg-gray-50"]:hover { background-color:#2c2724 !important; }
        html.dark [class~="hover:bg-gray-100"]:hover,
        html.dark [class~="hover:bg-gray-200"]:hover { background-color:#2b2724 !important; }
        ...
        html.dark [class~="hover:border-purple-300"]:hover { border-color:#57534e !important; }
        html.dark [class~="bg-white/70"] { background-color:rgba(17,24,39,0.8) !important; color:#e7e5e4 !important; }
        ...
        html.dark [class~="from-gray-50"] { --tw-gradient-from:#221f1d !important; --tw-gradient-stops:var(--tw-gradient-from), var(--tw-gradient-to) !important; }
        html.dark [class~="to-gray-100"] { --tw-gradient-to:#2c2724 !important; }
        ...
        html.dark [class~="to-white"] { --tw-gradient-to:#221f1d !important; }
        ...
        html.dark [class~="text-gray-300"] { color:#57534e !important; }
        ...
        html.dark [class~="bg-stone-100"] { background-color:#2c2724 !important; }
        ...
        html.dark [class~="bg-white/50"] { background-color:rgba(17,24,39,0.6) !important; color:#e7e5e4 !important; }
        html.dark [class~="bg-white/90"] { background-color:rgba(17,24,39,0.92) !important; color:#e7e5e4 !important; }
        ...
        html.dark [class~="group-hover:border-purple-200"]:hover { border-color:#57534e !important; }
        ...
        html.dark [class~="hover:text-gray-700"]:hover { color:#d6d3d1 !important; }
        ...
        html.dark [class~="hover:border-gray-300"]:hover { border-color:#57534e !important; }
        ...
        html.dark [class~="border-gray-400"] { border-color:#332f2c !important; }
        html.dark [class~="border-amber-100"],
        html.dark [class~="border-amber-300"],
        html.dark [class~="border-green-300"] { border-color:#332f2c !important; }
        ...
        html.dark [class~="xl:border-gray-200"] { border-color:#332f2c !important; }
        ...
        html.dark [class~="border-[#055457]/20"] { border-color:#332f2c !important; }
        html.dark [class~="bg-[#D1D1D1]/40"] { background-color:rgba(68,64,60,0.5) !important; }
        ...
        html.dark .section-card { background:#221f1d !important; border-color:#332f2c !important; box-shadow:0 8px 30px rgba(0,0,0,0.35) !important; }
        html.dark .detail-icon { background:#052e1a !important; color:#86efac !important; }
        html.dark .detail-row { border-color:#2b2724 !important; }
        html.dark .traj-row { background:#1c1917 !important; border-color:#332f2c !important; }
        html.dark .step-dot.pending { background:#2c2724 !important; color:#78716c !important; border-color:#332f2c !important; }
        html.dark .step-dot.done { background:#052e1a !important; color:#86efac !important; border-color:#14532d !important; }
        .theme-toggle { width:2.5rem; height:2.5rem; display:inline-flex; align-items:center; justify-content:center; border-radius:9999px; border:1px solid #e7e5e4; color:#78716c; background:#fff; transition:all .2s ease; }
        .theme-toggle:hover { color:#16a34a; border-color:#86efac; background:#f0fdf4; }
        html.dark .theme-toggle { background:#1c1917; border-color:#332f2c; color:#d6d3d1; }
        html.dark .theme-toggle:hover { background:#13251c; color:#86efac; border-color:#16a34a; }
        .theme-toggle-floating { position:fixed; top:1rem; right:1rem; z-index:60; box-shadow:0 12px 30px rgba(28,25,23,.12); }
        ...
        .admin-table-scroll th:last-child { position:sticky; right:0; z-index:1; background:inherit; box-shadow:-12px 0 18px -18px rgba(28,25,23,.45); }

function installThemeStyles() {
    ...
    style.textContent = `
        ...
        html.dark body { background:#0c1210 !important; color:#e8ede9 !important; }
        html.dark .glass-nav,
        html.dark nav.glass-nav { background:rgba(12,18,16,0.94) !important; border-color:rgba(38,48,43,0.9) !important; }
        html.dark [class~="bg-white"],
        html.dark [class~="bg-stone-50"],
        html.dark [class~="bg-gray-50"],
        html.dark [class~="bg-white/95"],
        html.dark [class~="bg-stone-50/60"] { background-color:#131a17 !important; }
        html.dark [class~="bg-gray-100"],
        html.dark [class~="bg-gray-50/50"],
        html.dark [class~="bg-gray-50/70"] { background-color:#1a231e !important; }
        html.dark [class~="bg-brand-50"] { background-color:#12281e !important; }
        ...
        html.dark [class~="bg-green-50"] { background-color:#12281e !important; }
        ...
        html.dark [class~="border-green-100"] { border-color:#26302b !important; }
        html.dark [class~="divide-gray-50"] > :not([hidden]) ~ :not([hidden]) { border-color:#26302b !important; }
        html.dark [class~="text-gray-900"],
        html.dark [class~="text-stone-800"] { color:#f4f7f5 !important; }
        html.dark [class~="text-gray-700"],
        html.dark [class~="text-stone-700"],
        html.dark [class~="text-gray-800"],
        html.dark [class~="text-gray-600"] { color:#a9b5ad !important; }
        html.dark [class~="text-blue-800"],
        html.dark [class~="text-blue-900"] { color:#93c5fd !important; }
        html.dark [class~="text-emerald-500"],
        html.dark [class~="text-emerald-600"] { color:#8ccda8 !important; }
        html.dark [class~="text-gray-500"],
        html.dark [class~="text-stone-500"],
        html.dark [class~="text-gray-400"] { color:#77837b !important; }
        html.dark [class~="text-brand-600"],
        html.dark [class~="text-brand-700"] { color:#8ccda8 !important; }
        ...
        html.dark input,
        html.dark textarea,
        html.dark select { background:#131a17 !important; color:#e8ede9 !important; border-color:#26302b !important; }
        html.dark .input-field::placeholder,
        html.dark input::placeholder,
        html.dark textarea::placeholder { color:#77837b !important; }
        html.dark table thead,
        html.dark [class~="bg-gray-50"] thead { background:#1a231e !important; }
        html.dark tr:hover { background:#1a231e !important; }

        /* ── Fondos claros restantes ── */
        html.dark [class~="bg-brand-50/50"],
        html.dark [class~="bg-brand-100"] { background-color:#12281e !important; }
        html.dark [class~="bg-gray-200"] { background-color:#26302b !important; }
        html.dark [class~="bg-gray-50/30"] { background-color:rgba(26,35,30,0.4) !important; }
        html.dark [class~="bg-green-100"] { background-color:#12281e !important; }
        ...
        html.dark [class~="border-sun-200"] { border-color:#26302b !important; }
        html.dark [class~="border-gray-50"] { border-color:#1e2721 !important; }
        html.dark img[class~="border-white"],
        html.dark [class~="border-white"] { border-color:#1a231e !important; }

        /* ── Hovers: sin fogonazos blancos en oscuro ── */
        html.dark [class~="hover:bg-white"]:hover,
        html.dark [class~="hover:bg-gray-50"]:hover { background-color:#1a231e !important; }
        html.dark [class~="hover:bg-gray-100"]:hover,
        html.dark [class~="hover:bg-gray-200"]:hover { background-color:#26302b !important; }
        ...
        html.dark [class~="hover:bg-green-100"]:hover { background-color:#12281e !important; }
        ...
        html.dark [class~="hover:border-purple-300"]:hover { border-color:#3a463f !important; }
        html.dark [class~="bg-white/70"] { background-color:rgba(19,26,23,0.8) !important; color:#e8ede9 !important; }

        /* ── Degradados decorativos (hero, conectores de ruta) ── */
        html.dark [class~="from-brand-200"] { --tw-gradient-from:#1b4433 !important; --tw-gradient-stops:var(--tw-gradient-from), var(--tw-gradient-to) !important; }
        ...
        html.dark [class~="to-brand-50"] { --tw-gradient-to:#12281e !important; }
        html.dark [class~="to-brand-100"] { --tw-gradient-to:#1b4433 !important; }
        html.dark [class~="from-gray-50"] { --tw-gradient-from:#131a17 !important; --tw-gradient-stops:var(--tw-gradient-from), var(--tw-gradient-to) !important; }
        html.dark [class~="to-gray-100"] { --tw-gradient-to:#1a231e !important; }
        html.dark [class~="from-brand-50"] { --tw-gradient-from:#12281e !important; --tw-gradient-stops:var(--tw-gradient-from), var(--tw-gradient-to) !important; }
        ...
        html.dark [class~="to-white"] { --tw-gradient-to:#131a17 !important; }

        /* ── Textos oscuros sobre fondos que se oscurecen ── */
        html.dark [class~="text-brand-800"],
        html.dark [class~="text-green-800"] { color:#8ccda8 !important; }
        html.dark [class~="text-red-900"],
        html.dark [class~="text-red-800"] { color:#fca5a5 !important; }
        html.dark [class~="text-gray-300"] { color:#3a463f !important; }
        ...
        html.dark [class~="bg-stone-100"] { background-color:#1a231e !important; }
        html.dark [class~="bg-sun-50"] { background-color:#422006 !important; }
        html.dark [class~="bg-brand-50/20"] { background-color:rgba(18,40,30,0.35) !important; }
        html.dark [class~="bg-gray-50/40"] { background-color:rgba(26,35,30,0.4) !important; }
        ...
        html.dark [class~="bg-white/50"] { background-color:rgba(19,26,23,0.6) !important; color:#e8ede9 !important; }
        html.dark [class~="bg-white/90"] { background-color:rgba(19,26,23,0.92) !important; color:#e8ede9 !important; }
        ...
        html.dark [class~="group-hover:border-purple-200"]:hover { border-color:#3a463f !important; }
        ...
        html.dark [class~="hover:text-gray-700"]:hover { color:#a9b5ad !important; }
        ...
        html.dark [class~="hover:text-brand-800"]:hover { color:#8ccda8 !important; }
        ...
        html.dark [class~="hover:border-gray-300"]:hover { border-color:#3a463f !important; }
        /* Focus rings (box-shadow via --tw-ring-color, no border-color) */
        html.dark [class~="ring-brand-100"] { --tw-ring-color:rgba(140,205,168,0.35) !important; }
        html.dark [class~="focus:ring-brand-100"]:focus { --tw-ring-color:rgba(140,205,168,0.35) !important; }
        ...
        html.dark [class~="text-brand-900"] { color:#8ccda8 !important; }
        ...
        html.dark [class~="border-gray-400"] { border-color:#26302b !important; }
        html.dark [class~="border-amber-100"],
        html.dark [class~="border-amber-300"],
        html.dark [class~="border-green-300"] { border-color:#26302b !important; }
        ...
        html.dark [class~="xl:border-gray-200"] { border-color:#26302b !important; }
        ...
        html.dark [class~="border-[#055457]/20"] { border-color:#26302b !important; }
        html.dark [class~="bg-[#D1D1D1]/40"] { background-color:rgba(38,48,43,0.5) !important; }
        ...
        html.dark .section-card { background:#131a17 !important; border-color:#26302b !important; box-shadow:0 8px 30px rgba(0,0,0,0.35) !important; }
        html.dark .detail-icon { background:#12281e !important; color:#8ccda8 !important; }
        html.dark .detail-row { border-color:#26302b !important; }
        html.dark .traj-row { background:#131a17 !important; border-color:#26302b !important; }
        html.dark .step-dot.pending { background:#1a231e !important; color:#77837b !important; border-color:#26302b !important; }
        html.dark .step-dot.done { background:#12281e !important; color:#8ccda8 !important; border-color:#1b4433 !important; }
        /* El toggle usa los tokens del sistema (tailwind.src.css), asi que ya
           cambia solo en oscuro: no necesita su propia regla html.dark. */
        .theme-toggle { width:2.25rem; height:2.25rem; display:inline-flex; align-items:center; justify-content:center; border-radius:6px; border:1px solid rgb(var(--line)); color:rgb(var(--ink-mute)); background:transparent; transition:color 180ms var(--ease-salida), border-color 180ms var(--ease-salida), background-color 180ms var(--ease-salida); }
        .theme-toggle:hover { color:rgb(var(--brand)); border-color:rgb(var(--brand)); background:rgb(var(--surface-alt)); }
        .theme-toggle-floating { position:fixed; top:1rem; right:1rem; z-index:60; background:rgb(var(--surface)); }
        ...
        .admin-table-scroll th:last-child { position:sticky; right:0; z-index:1; background:inherit; box-shadow:-12px 0 18px -18px rgba(12,18,16,.45); }

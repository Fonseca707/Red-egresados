...
const DELF_TEST_B1_1 = {
    ...
    // su audio solo: el clip que Juan genera desde ese botón queda emparejado
    // por transcript con el documento que le corresponde aquí.
    //
    // Las PREGUNTAS son de elaboración propia sobre esos documentos (el sujet
    // publica los guiones, no siempre el cuestionario). Respetan lo que sí es
    // oficial: 3 documentos de 7 + 9 + 9 = 25 puntos y puntuación NO uniforme
    // dentro de cada ejercicio (conviven ítems de 1 y de 1,5).
    co: {
        totalPoints: 25,
        // Pausas del nouveau format, medidas en la pista del surveillant.
        // Son la estructura real de la épreuve; el reproductor las respeta pero
        // deja saltarlas (decisión de Juan: practicar no es examinarse).
